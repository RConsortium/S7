...
describe("S4_register", {
  ...
  it("registers an S7 union so it can be used with S4 methods", {
    on.exit({
  ...
  it("registers S7 properties as slots for S4 subclasses", {
    on.exit({
  ...
  it("constructs S4 subclasses of S7 classes that extend S4 classes", {
  ...
  it("rejects properties that can not be represented as slots", {
    on.exit(S4_remove_classes(c(
  ...
  it("uses matching S4 unions as S4 slots", {
  ...
  it("uses registered S7 unions as S4 slots", {
    on.exit(S4_remove_classes(c(
