text <- new_class("text", parent = chr, constructor = function(text = character()) new_object(.data = text))
number <- new_class("number", parent = num, constructor = function(x) new_object(.data = x))
