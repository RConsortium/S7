...
new_class <- function(
  ...
  attr(object, "_S7_dispatch") <- S7_class_dispatch(name, package, parent)
...
# Dispatch vector for an S7 class; cached in the `_S7_dispatch` attribute
S7_class_dispatch <- function(name, package, parent) {
