...
`new_class()` returns the class object, a constructor which you can use to create objects that are instances of that type:
...
Properties are automatically validated against their type and with the validator specified in the class definition:
...
This is only needed if your generic has additional arguments that aren't dispatch on.
