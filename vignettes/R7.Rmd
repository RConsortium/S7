...
Sometimes you want to implement a method in terms of behaviour of the superclass. You can use `up_cast()` to dispatch to a method from parent class:

```{r}
method(bar, list(text, "double")) <- function(x, y, ...) {
  res <- bar(up_cast(x, "character"), y)
  paste0("2 ", res)
}
