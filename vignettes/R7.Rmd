...
Sometimes you want to implement a method in terms of behavior of the superclass. You can access the method for the parent by using `cast()`:

```{r}
method(bar, list(text, "double")) <- function(x, y, ...) {
  res <- bar(cast(x, "character"), y)
  paste0("2 ", res)
}
```
