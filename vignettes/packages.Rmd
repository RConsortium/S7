...
`S7_on_unload()` undoes the work of `S7_on_load()`: it unregisters the methods that your package registered for generics in other packages and removes the hooks that `S7_on_load()` added, so unloading your package doesn't leave stale methods behind.
