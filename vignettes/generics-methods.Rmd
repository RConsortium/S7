...
If you're defining methods for an S7 generic in another package there are a couple of extra steps you need to take:
...
-   You need to call `S7::external_methods_register()` when your package is loaded:
