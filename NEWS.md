...
* `S7_class_desc()` is a new exported helper that formats a class specification as a short human-readable string, useful for error messages and tooling like roxygen2 (#594).
