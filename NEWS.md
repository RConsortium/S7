...
* The default constructor generated by `new_class()` now forwards arguments to the parent constructor via `...` instead of copying the parent's formals. This means parent property defaults are evaluated in the parent constructor's environment, and child classes can override parent properties (including their defaults and setters) (#609, #467, #585).
