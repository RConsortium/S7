...
* `prop()` and `prop<-()` errors from getters and setters (including customised) now report a synthetic `<Class>@<prop>` call, making it easier to see which property triggered the error (#416, #536, #638).
