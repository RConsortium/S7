...
* New `class_condition`, `class_error`, `class_warning`, and `class_message` wrap the base condition classes, making it easier to use S7 to define custom condition classes (#586).
