...
* `S7_generic_call()` and `S7_user_frame()` are new helpers that give a method stable access to the originating call to the generic and the caller's frame, even in the presence of `super()` (#596).
